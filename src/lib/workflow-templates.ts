...
export const WORKFLOW_TEMPLATES: readonly WorkflowTemplate[] = [
  {
    ...
    workflow: {
      ...
      nodes: [
        ...
        { id: 'team-lead', agent: 'team-lead', task: 'Consolidate reviews and make final decision', depends_on: ['code-reviewer', 'security-reviewer'], checkpoint: true },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    workflow: {
      ...
      nodes: [
        ...
        { id: 'team-lead', agent: 'team-lead', task: 'Approve and merge fix', depends_on: ['reviewer'], reports_to: ['user'], checkpoint: true },
      ],
    },
  },
] as const;
